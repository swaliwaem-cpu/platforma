...
export const IMAGE_VARIANT_SPECS: Record<FileVariantKind, { width: number; quality: number; suffix: string }> = {
  [FileVariantKind.THUMBNAIL]: {
    width: 240,
    quality: 68,
    suffix: 'thumbnail',
  },
  [FileVariantKind.CARD]: {
    width: 640,
    quality: 72,
    suffix: 'card',
  },
  [FileVariantKind.DETAIL]: {
    width: 1440,
    quality: 78,
    suffix: 'detail',
  },
...
export const IMAGE_VARIANT_ORDER = [
  FileVariantKind.THUMBNAIL,
  FileVariantKind.CARD,
  FileVariantKind.DETAIL,
] as const;
...
export function createImageVariantKey(originalKey: string, variant: FileVariantKind) {
