// Classes of residential projects. Keep in sync with property-class.mjs.
const PROPERTY_CLASSES = ['Комфорт-класс', 'Бизнес-класс', 'Премиум-класс', 'Делюкс'];
...
function normalizePropertyClass(value) {
