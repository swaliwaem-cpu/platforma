...
const fskFeedFormatMigrationPath = path.join(
  rootDir,
...
test('FSK feed format migration adds fsk_xml enum value', () => {
  assert.equal(fs.existsSync(fskFeedFormatMigrationPath), true);
